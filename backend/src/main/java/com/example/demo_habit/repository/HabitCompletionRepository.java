...
public interface HabitCompletionRepository extends JpaRepository<HabitCompletion, Long> {
    ...
    List<HabitCompletion> findByHabitAndCompletionDateBetween(Habit habit, LocalDateTime startDate, LocalDateTime endDate);
    Optional<HabitCompletion> findByHabitAndCompletionDate(Habit habit, LocalDateTime completionDate);
